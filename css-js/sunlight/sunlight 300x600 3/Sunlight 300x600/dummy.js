...
$(document).ready(function () {
    ...
    //             fakeMessage();
    //             insertChoiceMade(choice);
    //             console.log(getRemainingOptions);
    //             ;
    ...
    function clickedChoice() {
        $('.message .choices').off().click(function () {
    ...
    function fakeMessage() {
      ...
      setTimeout(function () {
        ...
        if (i === 10) {
          ...
          let remainingOptions = getRemainingOptions(Fake[i].options);
          console.log(remainingOptions);
          $(`<div class="message new"><figure class="avatar"><img src="images/sunlight.png" /></figure>${Fake[i].question}<br>${remainingOptions}</div>`).appendTo($('.mCSB_container')).addClass('new');
          clickedChoice();
          updateScrollbar();
          console.log(remainingOptions);
          i++;
    ...
    function getRemainingOptions(options) {
      let remainingOptions = Array(options).filter(function (option) {
        console.log(!selectedOptions.includes(option));
        return !selectedOptions.includes(option);
      });
      return remainingOptions.join(', ');
    }
